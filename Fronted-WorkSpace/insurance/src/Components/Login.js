...
function Login() {
    ...
    const change=(e)=>
    {
          ...
          if(name === "name"){
            ...
            if(name === "password")
            {
              ...
              {
                setValidationErrors({ ...validationErrors, [name]: "password must be 1 upper & speacial symbol & digit ex: Abc@1" });
              } else {
                setValidationErrors({ ...validationErrors, [name]: "" });
              }
            }
    ...
    <div class=" container row text-center" >
            ...
            <div class="form-group mt-4 mx-auto " >
              <label class="control-label col-lg-4 col-md-6 col-sm-6 col-12 ">UserName :</label>
